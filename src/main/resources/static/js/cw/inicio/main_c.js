			...
			var errorElement = 'em';
				...
				function listarRegistros() {
				    ...
				    if ($("#frm_busqueda").valid()) {
				        ...
				        var tipo = 2;//Capacitaciones
				        if(comodin == null || comodin == ""){comodin = "0";}
				        $table.bootstrapTable({
				        	url: _ctx+'gestion/contenido-web/obtenerListado/'+tipo+'/'+comodin,
				        	pagination: true,
					                ...
					                success: function (data, textStatus) {
					                    if (textStatus == "success") {
					                    	if(data == "-1"){
						                        ...
						                        actualStatus = document.querySelector('#tblRegistros tbody tr[data-index=\''+ix+'\']').children[2].children[0].textContent;
